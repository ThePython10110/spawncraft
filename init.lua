...
local vl = minetest.get_game_info().title:find("VoxeLibre")
...
if minetest.settings:get_bool("spawncraft_enderman", true) then
  minetest.register_craft({
    output = vl and "mobs_mc:rover" or "mobs_mc:enderman",
    recipe = {
...
if minetest.settings:get_bool("spawncraft_creeper", true) then
  minetest.register_craft({
    output = vl and "mobs_mc:stalker" or "mobs_mc:creeper",
    recipe = {
...
if minetest.settings:get_bool("spawncraft_pillager", true) then
  minetest.register_craft({
  ...
  if minetest.settings:get_bool("spawncraft_vindicator", true) then
    minetest.register_craft({
      output = "mobs_mc:pillager",
      type = "shapeless",
  ...
  if minetest.settings:get_bool("spawncraft_evoker", true) then
    minetest.register_craft({
      output = "mobs_mc:pillager",
      type = "shapeless",
  ...
  if minetest.settings:get_bool("spawncraft_illusioner", true) then
    minetest.register_craft({
      output = "mobs_mc:pillager",
      type = "shapeless",
